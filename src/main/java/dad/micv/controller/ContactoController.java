...
import dad.micv.App;
import dad.micv.dialog.EmailDialog;
import dad.micv.dialog.TelefonoDialog;
import dad.micv.dialog.WebDialog;
...
//	private ListProperty<Telefono> telefonosList = new SimpleListProperty<>(FXCollections.observableArrayList());
//	private ListProperty<Email> emailList = new SimpleListProperty<>(FXCollections.observableArrayList());
//	private ListProperty<Web> webList = new SimpleListProperty<>(FXCollections.observableArrayList());
...
//		telTableView.itemsProperty().bind(telefonosList);
//		deleteTel.disableProperty().bind(telTableView.getSelectionModel().selectedItemProperty().isNull());
//
//		emailTableView.itemsProperty().bind(emailList);
//		deleteEmailButton.disableProperty().bind(emailTableView.getSelectionModel().selectedItemProperty().isNull());
//
//		websTableView.itemsProperty().bind(webList);
//		deleteWebButton.disableProperty().bind(websTableView.getSelectionModel().selectedItemProperty().isNull());
	...
	void onDeleteTelAction(ActionEvent event) {
		...
		alert.setContentText(
				"¿Quiere eliminar el siguiente teléfono? " + telTableView.getSelectionModel().getSelectedItem().getNumero());
	...
	void onDeleteEmailAction(ActionEvent event) {
		...
		alert.setHeaderText(null);
		alert.setContentText(
				"¿Quiere eliminar el siguiente e-mail? " + emailTableView.getSelectionModel().getSelectedItem().getDireccion());
		Optional<ButtonType> action = alert.showAndWait();
...
//    	webDialog.setTitle("Nuevo e-mail");
//    	webDialog.setHeaderText("Crear una nueva dirección de correo.");
