...
import dad.micv.App;
import dad.micv.dialog.ExperienciaDialog;
...
public class ExperienciaController implements Initializable {
    ...
    void onDeleteExperiencia(ActionEvent event) {
		...
		alert.setContentText(
				"¿Quiere eliminar la siguiente experiencia? " + experienciaTableView.getSelectionModel().getSelectedItem().getDenominacion());
